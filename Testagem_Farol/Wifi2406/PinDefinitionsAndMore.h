...
#define IR_RECEIVE_PIN   2 // PA3 - on Digispark board labeled as pin 9
...
#define IR_RECEIVE_PIN      2  // GPIO15 Start with pin 3 since pin 2|GPIO25 is connected to LED on Pi pico
...
#define IR_RECEIVE_PIN      2  // to be compatible with the Arduino Nano RP2040 Connect (pin3)
